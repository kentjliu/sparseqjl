...
from model.llama3_utils_qjl import QJLSketch, QJLKeyQuantizer, repeat_kv_quant
...
class LlamaAttention_QJL(nn.Module):
    ...
    def forward(
        ...
        cos, sin = self.rotary_emb(value_states, position_ids=kv_seq_len)
        ...
        if past_key_value is not None:
            ...
            if value_states_quant is None:
                ...
                attn_output = cuda_quantized_bmm_dynamic(self.group_size, attn_weights[:, :, :, :-value_full_length],
                                                         ...
                                                         value_scale_repeat, value_mn_repeat, self.value_quantization_bits)
...
class Llama3ForCausalLM_QJL(LlamaPreTrainedModel):
